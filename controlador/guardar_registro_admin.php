...
$sql = "INSERT INTO usuario (nombre, usuario,correo,itelefono, contraseña, id_cargo) VALUES ('$nombre', '$usuario', '$correo', '$telefono', '$password', '$rol')";
